...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a
          href="{{ route('vendor.listing_management.listing.products', ['id' => $listing_id, 'language' => $defaultLang->code]) }}">{{ __('Products') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block"
            href="{{ route('vendor.listing_management.listing.products', ['id' => $listing_id, 'language' => $defaultLang->code]) }}">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="productForm" action="{{ route('vendor.listing_management.listing.store_product') }}"
